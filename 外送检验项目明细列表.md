...
```
GET 
http://go-api-local-old.gstyun.cn/inspect/handler/QueryOutsendItemList?clinic_id=311&user_name=周小北&page_size=1&page_no=1&item_name=试验&item_code=0602012000162
```
...
| `start_time` > `end_time` | 86017 | 参数错误，时间范围非法 |
```
{
  "id": "srv.inspect",
  "code": 86017,
  "detail": "start_time 不能大于 end_time",
  "status": "Status Params Not Set"
}
```
```
{
